...
- data structure to store tabular data (`tidyverse` extension of `data.frame` structure)
...
- *quote* column/variable *names not meating standard* syntax requirements (e.g. with spaces etc.)
